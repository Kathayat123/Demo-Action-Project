...
//numeric with dot
function CreateNumericwithdotTextBox(input, event, AllowDot) {
    ...
    if (parseInt(keyCode) == 8 || parseInt(keyCode) ==46 || parseInt(keyCode) == 9)
     { return true; }
...
function CreateAlphaNumericTextBox(input, event) {
    ...
    if (parseInt(keyCode) == 8 || parseInt(keyCode) == 9 || parseInt(keyCode) == 32) { return true; }
    input.focus();
    return false;
...
function CreateStringTextBoxForOthers(input, event) {
    ...
    //Space-Return-Dot
    if (parseInt(keyCode) == 32 || parseInt(keyCode) == 13 || parseInt(keyCode) == 40 || parseInt(keyCode) == 41 || parseInt(keyCode) == 46 || parseInt(keyCode) == 8 || parseInt(keyCode) == 9 || parseInt(keyCode) == 44 || parseInt(keyCode) == 58 || parseInt(keyCode) == 64 || parseInt(keyCode) == 95 || parseInt(keyCode) == 45 || parseInt(keyCode) == 38) {
