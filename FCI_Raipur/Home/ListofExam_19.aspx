            ...
            <div class="col-md-9 col-sm-8 col-xs-12">
                <div class="col-md-8 col-sm-12 col-xs-12" style="padding-left: 0">
                    ...
                    <p style="border-width: 1px; border-color: #0098be; border-style: solid; font-family: Verdana; color: black;">
                        <span runat="server" id="pMessage" visible="true">प्रिय आवेदक,
            <br />
                            <br />
                      
भारतीय खाद्य निगम ,(छ.ग.)-वॉचमैन की भर्ती में लिखित परीक्षा के अंक देखने के लिए वेबसाइट www.fcicgjobs.com  पर “Existing User” 
पर क्लिक करें फिर अपने Application Number तथा Password  की मदद से लॉगिन करें| 
