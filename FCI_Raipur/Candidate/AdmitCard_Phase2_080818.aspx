                    ...
                    <td style="width: 99%">
                        ...
                        <table style="width:100%;font-size:14px;border-width: thin; border-color:black; height: 25px;" border="1" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: top; width:80%" ><span style="font-size: 24px; font-weight: bold;">FOOD CORPORATION OF INDIA</span><br />
                                    ...
                                    <br />
                                    CALL LETTER FOR PHYSICAL ENDURANCE TEST (PET) AND DOCUMENT VERIFICATION (DV)

                                    </td>
                                <td style="vertical-align:top;padding-top:0.1cm;padding-left:0.7cm;width:10%; " >
                         ...
                         <table style="width:100%;font-size:12px;border-width: thin; border-color:black ;" border="1" cellpadding="0" cellspacing="0"  >
                             ...
                             <tr>
                                 <td style="height: 50px;" bgcolor="Silver"><strong>ROLL NO:</strong></td>
                                  ...
                                  <td style="width:20%;padding-left:.1cm;height:26px;" bgcolor="Silver" colspan="2"><strong>NAME AND ADDRESS OF PET & DV:</strong></td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ol style="justify-content:space-around ">
                            ...
                            <li>
                                On the basis of written test conducted on 24.09.17 for the post of Watchman Under Chhattisgarh Region, you have been provisionally shortlisted for Document Verification (DV) Followed by Physical Endurance Test (PET). May Please note that provisional Short listing does not mean final selection. The final selection would be based on clearing the PET which is qualifying in nature and subject to the merit based on written test vis-a-vis vacancies available; Accordingly, you are requested to present yourself for the same at the venue and time as above./  छत्तीसगढ़ क्षेत्र के तहत वॉचमैन पद के लिए 24.09.2017 को आयोजित लिखित परीक्षा के आधार पर, आपको शारीरिक दक्षता परीक्षण (पीईटी) और दस्तावेज़ सत्यापन (डीवी) के लिए अस्थायी रूप से सूचीबद्ध किया गया है। कृपया ध्यान दें कि अस्थायी लघु सूची का मतलब अंतिम चयन नहीं है। अंतिम चयन पीईटी को समाशोधन पर आधारित होगा जो वास्तविकता में अर्हता प्राप्त कर रहा है और उपलब्ध रिक्तियों के साथ लिखित परीक्षा के आधार पर योग्यता के अधीन होगा; तदनुसार, आपसे अनुरोध है कि आप ऊपर के स्थान और समय पर उपस्थिति रहे |

                                <br />
                            </li> 
                            <li>
                               Request for change of Date/ Time for PET & DV Centre/ Venue will not be entertained in any circumstances./ किसी भी परिस्थिति में पीईटी और डीवी केंद्र / स्थान और दिनांक / समय के परिवर्तन के लिए अनुरोध स्वीकार्य नहीं किया जाएगा।  <br />
                            </li> 
                             <li>
                                Admission to the PET & DV Centre/ Venue will be on the production of Identity Proof in Original and this call Letter ( Page-1,2, &3) only, Duly Completed./ पीईटी और डीवी केंद्र / स्थान में प्रवेश, मूल पहचान पत्र और कॉल लेटर के आधार पर (पृष्ठ -12, और 3) जो की विधिवत पूर्ण होगा।  <br />   
                             </li> 
                             <li>
                             ...
                             <li>
                                 Candidate must bring the following documents with them : (a) Admit Card (b) Written test Admit Card (Same Copy that was there on Written Test) (c) Original Aadhar Card (d) Original Documents of Educational Qualification that will prove (i) Date of Birth (ii) 8th Standard Marksheet (e) Original Documents for proof of desired relaxations like : OBC/SC/ST/ ExServiceman (f) Copy of Application Form (g) 2 passport size photographs (h) 2 Self- Attested Xerox copies of all documents (i) Fitness certificate from registered Civil Surgeon along with eye/vision test certificate.
                                 <br />
                                 Note :- All above mentioned documents are mandatory , without these documents you will not be allowed to take part in the Physical Endurance test.
                                <br />
                                 अभ्यर्थी को निम्नलिखित दस्तावेज अपने साथ अवश्य लाये : (ए) प्रवेश पत्र (बी) लिखित परीक्षा प्रवेश पत्र (लिखित परीक्षा पर वही प्रतिलिपि) (सी) मूल आधार कार्ड (डी) शैक्षणिक योग्यता के मूल दस्तावेज जो साबित होंगे (i ) जन्म तिथि (ii) 8 वीं मानक मार्कशीट (ई) वांछित छूट के सबूत के लिए मूल दस्तावेज जैसे: ओबीसी / एससी / एसटी / एक्स सर्विसेमैन (एफ) आवेदन पत्र की प्रतिलिपि (जी) 2 पासपोर्ट आकार की तस्वीरें (एच) 2 स्व-प्रमाणित सभी दस्तावेजों की जेरोक्स प्रतियां (i) पंजीकृत नागरिक सर्जन से आंख / दृष्टि परीक्षण प्रमाण पत्र के साथ स्वास्थ्य प्रमाण पत्र।
                                 <br />
                                 ध्यान दें:- उपरोक्त उल्लिखित दस्तावेज अनिवार्य हैं, इन दस्तावेजों के बिना आपको शारीरिक दक्षता परीक्षण में भाग लेने की अनुमति नहीं दी जाएगी।

                            </li> <br />
                             <li >
                                 Fitness certificate from the Registered Civil Surgeon along with Eye/Vision test has to be brought by the candidate at the time of attending the PET, Without  which the candidate shall not be allowed to appear in PET./ आईई / विजन टेस्ट का ,पंजीकृत सिविल सर्जन से स्वास्थ्य प्रमाण पत्र पीईटी में भाग लेने के समय उम्मीदवार द्वारा लाया जाना चाहिए जिसके बिना उम्मीदवार को पीईटी में शामिल होने की अनुमति नहीं दी जाएगी।

                            </li><br />
                             <li >
                                a. Certificate(s) in support of his/her claim of being SC/ST/OBC/PWD/Serving Defence Personnel/Ex serviceman etc. Issued by the Competent Authority as per the format(s)(Annexure A/B/C/D/E respectively) published in the advertisement If you are seeking age relaxation for being domiciled in the state of Jammu & Kashmir during the period 01.01.1980 to 31.12.1989,you also have to bring a certificate from the District Magistrate in the Kashmir Division./  अ. अनुसूचित जाति / अनुसूचित जनजाति / ओबीसी / पीडब्ल्यूडी / सेवा रक्षा कार्मिक / पूर्व सैनिक आदि की सेवा के अपने दावे के समर्थन में सर्टिफिकेट (प्रारूप) के अनुसार सक्षम प्राधिकारी द्वारा जारी (अनुबंध) ए / बी / सी / डी / ई क्रमशः) विज्ञापन में प्रकाशित यदि आप 01.01.1 9 80 से 31.12.1 9 8 9 की अवधि के दौरान जम्मू-कश्मीर राज्य में रहने के लिए आयु छूट चाहते हैं, तो आपको कश्मीर डिवीजन में जिला मजिस्ट्रेट से प्रमाण पत्र भी लेना होगा ।
                                     <br />
                                    b.   NOC: if you are employed with the State Govt/ Central Govt/PSUs, then ensure that during Document Verification./ एनओसी: यदि आप राज्य सरकार / केंद्र सरकार / पीएसयू के साथ नियोजित हैं, तो दस्तावेज़ सत्यापन के दौरान सुनिश्चित करें ।

                            </li> <br />
                             <li>
                                 May Please note that if you fail to appear at the given Venue & Time along with requisite documents for PET, your candidature will be cancelled. No further opportunity will be given./ कृपया ध्यान दें कि यदि आप पीईटी के लिए आवश्यक दस्तावेजों के साथ दिए गए स्थान और समय पर उपस्थित होने में विफल रहते हैं, तो आपकी उम्मीदवारी रद्द कर दी जाएगी। कोई और मौका नहीं दिया जाएगा।

                             </li>     <br />
                            
                            <li>
                                 Travelling and other expenses incurred for attending for PET & DV will be borne by the candidate himself/herself./ पीईटी और डीवी में भाग लेने के लिए यात्रा और अन्य व्यय उम्मीदवार द्वारा स्वयं  भुगतान किया जाएगा।

                             </li>     <br />
                            
                            <li>
                                 Your Candidature is provisional. You must, therefore, ensure that you fulfil all the conditions of eligibility laid down in the advertisement/ notice of the Examination. If at any stage it is found that you do not fulfil any of the conditions of eligibility, your candidature will be cancelled and no appeal against such  cancellation will be entertained. The fact that you have been called for DV/Physical Endurance Test does not confer any right to be treated as eligible in all aspects for appointment or to be considered for the post. To avoid any disappointment at a later stage, you are advised to recheck whether you meet all the eligibility criteria laid down on the crucial date prescribed for the examination in question./ आपकी उम्मीदवारी अस्थायी है। इसलिए, आपको यह सुनिश्चित करना होगा कि आप परीक्षा के विज्ञापन / नोटिस में निर्धारित योग्यता की सभी शर्तों को पूरा करें। यदि किसी भी स्तर पर यह पाया जाता है कि आप योग्यता की किसी भी शर्त को पूरा नहीं करते हैं, तो आपकी उम्मीदवारी रद्द कर दी जाएगी और इस तरह के रद्दीकरण के खिलाफ कोई अपील नहीं की जाएगी। तथ्य यह है कि आपको DV / Physical Endurance Test के लिए बुलाया गया है, नियुक्ति के लिए सभी पहलुओं में पात्र के रूप में या पद के लिए विचार करने के लिए योग्य होने का कोई अधिकार नहीं है। बाद के चरण में किसी भी निराशा से बचने के लिए, आपको सलाह दी जाती है कि आप जांच में परीक्षा के लिए निर्धारित महत्वपूर्ण तारीख पर निर्धारित सभी योग्यता मानदंडों को पूरा करते हैं या नहीं।
