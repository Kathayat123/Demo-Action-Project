<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MasterPage1.master" AutoEventWireup="true" CodeFile="Preview.aspx.cs" Inherits="Candidate_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-1" style="width: 98%; top: 0px; left: 0px;">
                <div class="form-horizontal">
                                ...
                                <tr style="vertical-align: top;">
                                    ...
                                    <td colspan="4">
                                        <table border="0" style="width: 100%;">
                                            ...
                                            <tr runat="server">
                                                <td style="width: 32%">
                                                    <asp:Label ID="Label1" Text="Tehsil/City/तहसील/शहर:" runat="server"></asp:Label>
                                                    &nbsp;</td>
                                                <td>
                    ...
                    <h4 style="font-style: italic; font-weight: bold; font-family: Verdana; font-size: 16px; color: blue; display: none;" class="center">Payment Status</h4>
                    <div style="display: none;">
                        <table class="table table-striped table-bordered dataTable no-footer">
                            <thead>
                                <tr>
                                    <th width="25%">Fee Details</th>
                                    <th width="25%">Transaction ID (Bank Journnal No.) Or NEFT UTR No.</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="1" valign="middle" align="center">
                                        <%--<asp:Button ID="btnprint" runat="server" Text="PRINT" BackColor="#3F8B3F" ForeColor="White" Width="100px" OnClientClick="javascript:window.print();" class="btn btn-lg btn-primary btn-block" />--%>

                                        <asp:Button ID="btnSubmit" runat="server" Text="SUBMIT" BackColor="#3F8B3F" Width="110px"
                                            ForeColor="White" class="btn btn-lg btn-primary btn-block" OnClick="btnSubmit_Click" Visible="true" />
                                    </td>
                                    <td>
                                        <asp:Button ID="Button1" runat="server" Text="MODIFY" BackColor="#3F8B3F" Width="110px"
                                            ForeColor="White" class="btn btn-lg btn-primary btn-block" OnClick="Button1_Click" Visible="true" />
                                    </td>
                                    <td colspan="1" valign="middle" align="center">
                                        <asp:Button ID="btnNext" runat="server" Visible="false" Text="PROCEED TO PAYMENT" BackColor="#3F8B3F" ForeColor="White" Width="250px" OnClick="btnNext_Click"
