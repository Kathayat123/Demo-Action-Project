...
<body>
    ...
    <div id="wrapper">
        <h1><a href="">
            <img src="images/logo.gif" height="47" /></a></h1>
        <table style="width: 528px;margin-top:1px">
            <tr>
                <td style="width: 7%"></td>
                <td class="style2">&nbsp;</td>
                <td style="width: 7%"></td>
            ...
            <tr runat="server" visible="false">
                <td colspan="2" align="center">DASH BOARD</td>
                <td colspan="2" align="center">ADD COLLEGE</td>
                <td colspan="3" align="center">EDIT COLLEGE</td>
                <td colspan="4" align="center">ADD/EDIT EXAM DATE</td>
                <td align="center" colspan="3">GET SCHEDULED DATA</td>
                <td align="center" colspan="6">LOG OUT</td>
        ...
        <div id="booking">
            <h2 style="height: 33px;">
                <br />
                <font style="color: White; font-weight: bold; font-family: Arial; font-size: 15px; text-transform: capitalize;">FCI Login </font></h2>
        ...
        <!-- end main -->
        <div id="footer">© Copyright ATTEST Booking Window</div>
        <!-- end footer -->
    </div>
    <!-- end wrapper -->
</body>
